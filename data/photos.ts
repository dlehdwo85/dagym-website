...
export const photos = {
  ...
  "hero-community-lobby": {
    file: "/images/hero/hero-access-lobby-v4-21x9.webp",
    subject: "커뮤니티센터 출입구 — 데스크에 바로 붙은 스피드 게이트, 오른쪽 게이트 캐비닛 상단(앞 끝에서 약간 안쪽)에 폴 거치형 얼굴인식 단말 1대(서서 얼굴 높이, 실제 설치 사진 기준), 유리벽 너머 피트니스. 우회 동선 없음 · 인물 없음",
    size: "2400 × 1029",
    ratio: "21:9 (가로)",
