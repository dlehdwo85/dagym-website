...
export const photos = {
  ...
  "visual-business-apartment-wide": {
    ...
    alt: "골프연습장과 GX룸, 스터디 라운지가 이어진 아파트 커뮤니티 시설 (연출 이미지)",
    provenance: "generated",
  },
  "visual-business-sports": {
    file: "/images/business/sports.webp",
    subject: "운영 중인 피트니스센터 — 태블릿으로 기구를 점검하는 트레이너",
    size: "1600 × 1207",
    ratio: "4:3",
    usedIn: "사업 상세 — 스포츠 · 피트니스 Hero",
    alt: "정돈된 피트니스센터에서 태블릿으로 기구를 점검하는 트레이너 (연출 이미지)",
    provenance: "generated",
  },
  "visual-business-sports-wide": {
    ...
    alt: "창가를 따라 늘어선 유산소 기구와 프리웨이트 존이 있는 피트니스 클럽 (연출 이미지)",
    provenance: "generated",
  },
  "visual-business-hotel": {
    ...
    alt: "호텔 라운지와 유리 너머 피트니스, 실내 수영장 (연출 이미지)",
    provenance: "generated",
  },
  "visual-business-corporate-wide": {
    ...
    alt: "사내 피트니스와 임직원 라운지, 다목적실이 있는 기업 사옥 복지 공간 (연출 이미지)",
    provenance: "generated",
  },
  "visual-business-consulting": {
    file: "/images/business/consulting.webp",
    subject: "시설 진단 — 태블릿 · 도면을 든 운영 담당자가 노후 헬스장을 점검",
    size: "1600 × 1195",
    ratio: "4:3",
    usedIn: "사업 상세 — 운영 컨설팅 Hero",
    alt: "도면과 태블릿을 들고 노후한 커뮤니티 헬스장을 점검하는 운영 담당자 (연출 이미지)",
    provenance: "generated",
  },
  "visual-business-consulting-wide": {
    file: "/images/business/consulting-wide.webp",
    subject: "도면 · 이용 차트 · 체크리스트로 진행하는 시설 진단 작업",
    size: "2400 × 1029",
    ratio: "21:9",
    usedIn: "사업 상세 — 운영 컨설팅 진단 대상",
    alt: "도면과 이용 현황 차트를 놓고 시설 개선을 검토하는 모습 (연출 이미지)",
    provenance: "generated",
  },
  "visual-business-equipment": {
    file: "/images/business/equipment.webp",
    subject: "운동기구 설치 — 새 기구와 스크린골프 타석",
    size: "1600 × 1207",
    ratio: "4:3",
    usedIn: "사업 상세 — 시설 지원 Hero",
    alt: "새 운동기구를 설치하는 기사와 스크린골프 타석 (연출 이미지)",
    provenance: "generated",
  },
  "visual-business-equipment-wide": {
    ...
    alt: "새로 구축한 스크린골프 타석 세 곳 (연출 이미지)",
    provenance: "generated",
  },
